...
public class Main {
    ...
    public static void deleteUser(Statement statement,Scanner scanner){
        ...
        System.out.println("1. Delete permenantly");
        ...
        switch (choice){
            case 1:
                deletePermanently(statement,id);
                break;
            case 2:
                changeStatus(statement,id);
                break;
            case 3:
                break;
        }
    ...
    public static void deletePermanently(Statement statement,int id){
    ...
    public static void changeStatus(Statement statement, int id){
